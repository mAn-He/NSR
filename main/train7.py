...
parser.add_argument('--dir_path', type=str, default='model_state_dict', help='Directory path to save the model state dict (default="model_state_dict")') 
parser.add_argument('--train_dataset',type=str, default='../dataset/nsr_train.csv',help='train dataset path (default="../dataset/nsr_train.csv")')
parser.add_argument('--test_dataset',type=str, default='../dataset/nsr_test.csv',help='test dataset path (default="../dataset/nsr_test.csv")')
parser.add_argument('--random_seed',type=int, default=42,help='random seed (default=42)')
parser.add_argument('--image_size',type=int,default=256,help='image size for transforming (default=256)')
parser.add_argument('--learning_rate',type=float,default=0.0000001,help='learning rate (default=0.0000001)')
...
parser.add_argument('--model_path',type=str,default='engines/models_transformer.py',help='model.py path')
